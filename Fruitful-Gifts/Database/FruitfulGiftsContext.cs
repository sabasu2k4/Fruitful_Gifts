...
public partial class FruitfulGiftsContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.MaBv).HasName("PK__BaiViet__272475F5A1E68DE3");
        ...
        {
            entity.HasKey(e => e.IdBinhLuan).HasName("PK__BinhLuan__A6E39FBF3FA85EC2");
        ...
        {
            entity.HasKey(e => e.MaChatLieu).HasName("PK__ChatLieu__453995BC0EFBE870");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ChiTietD__3214EC0790E5A22D");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ChiTietG__3214EC0766D4E242");
        ...
        {
            entity.HasKey(e => new { e.MaGq, e.MaSp }).HasName("PK__ChiTietG__F557FE6B23E896E9");
        ...
        {
            entity.HasKey(e => new { e.MaNhap, e.MaSp }).HasName("PK__ChiTietN__F13D5F1FCE7F93A7");
        ...
        {
            entity.HasKey(e => e.MaDm).HasName("PK__DanhMucG__2725864E8062CBFA");
        ...
        {
            entity.HasKey(e => e.MaLoai).HasName("PK__DanhMucS__730A5759BC07182D");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__DichVuCo__3214EC07B703F8BD");
        ...
        {
            entity.HasKey(e => e.MaDh).HasName("PK__DonHang__2725864126EA4BF1");
        ...
        {
            entity.HasKey(e => e.MaDvt).HasName("PK__DonViTin__3D824D16F983E69E");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Footer__3214EC076D1408CC");
        ...
        {
            entity.HasKey(e => e.MaGq).HasName("PK__GioQua__2725AEEC1BD061DA");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Header__3214EC0774C5AC70");
        ...
        {
            entity.HasKey(e => e.MaKh).HasName("PK__KhachHan__2725CF7EBDCF894B");

            entity.ToTable("KhachHang");

            entity.HasIndex(e => e.TaiKhoanId, "UQ__KhachHan__9A124B4495B75489").IsUnique();
        ...
        {
            entity.HasKey(e => e.MaKho).HasName("PK__KhoHang__3BDA935067CB2615");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__KhuyenMa__3214EC075B9B4AFE");
        ...
        {
            entity.HasKey(e => e.MaLh).HasName("PK__LienHe__2725C75FB55ACBEB");
            ...
            entity.HasOne(d => d.MaNvNavigation).WithMany(p => p.LienHes)
                .HasForeignKey(d => d.MaNv)
                .HasConstraintName("FK_LienHe_NhanVien");
        });

        modelBuilder.Entity<Luong>(entity =>
        {
            entity.HasKey(e => e.MaLuong).HasName("PK__Luong__6609A48D5DB3E93C");
        ...
        {
            entity.HasKey(e => e.MaNcc).HasName("PK__NhaCungC__3A1951E3077EBA4D");
        ...
        {
            entity.HasKey(e => e.MaNv).HasName("PK__NhanVien__2725D76AC4A9224F");

            entity.ToTable("NhanVien");

            entity.HasIndex(e => e.TaiKhoanId, "UQ__NhanVien__9A124B44E29298E3").IsUnique();
        ...
        {
            entity.HasKey(e => e.MaNhap).HasName("PK__NhapHang__234F0F98D83C6847");
        ...
        {
            entity.HasKey(e => e.MaPt).HasName("PK__PhuongTh__2725E7D681CF23B2");
        ...
        {
            entity.HasKey(e => e.MaSp).HasName("PK__SanPham__2725087CA7A1C342");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__SanPhamY__3214EC0710C89239");
        ...
        {
            entity.HasKey(e => e.TaiKhoanId).HasName("PK__TaiKhoan__9A124B451C24FEDA");

            entity.ToTable("TaiKhoan");

            entity.HasIndex(e => e.TenDangNhap, "UQ__TaiKhoan__55F68FC0766F9D60").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ThanhToa__3214EC07AA8A2290");
        ...
        {
            entity.HasKey(e => e.MaTrangThai).HasName("PK__TrangTha__AADE4138E411DBF8");
        ...
        {
            entity.HasKey(e => e.MaXuatXu).HasName("PK__XuatXu__27BB6B19B672E81D");
